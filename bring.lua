return function(C, R, UI)
    ...
    local pelts = {"Bunny Foot","Wolf Pelt","Alpha Wolf Pelt","Bear Pelt","Scorpion Shell","Polar Bear Pelt","Arctic Fox Pelt","Basic Egg","Lightning Egg","Chick Egg","Pelt Egg", "Frog Egg","Alien Egg","Cooked Egg","Cracked Egg","Snow Egg","Volcanic Egg","Fish Egg","Jungle Egg","Basketball Egg"}
