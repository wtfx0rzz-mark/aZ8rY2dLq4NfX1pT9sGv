return function(C, R, UI)
    ...
    local weaponsArmor = {
        ...
        "Chainsaw","Crossbow","Katana","Kunai","Laser Cannon","Ray Gun","Infernal Sword","Laser Sword","Ice Sword","Poison Claws","Morningstar","Riot Shield","Spear","Tactical Shotgun","Wildfire",
