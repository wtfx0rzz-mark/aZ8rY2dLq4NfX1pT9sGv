return function(C, R, UI)
    ...
    local junkItems = {
        ...
        "Metal Chair","Cultist Prototype","Cultist Experiment","UFO Scrap","UFO Component","Gears"
    }
    ...
    local foodItems = {
        ...
        "Carrot",
        "Chilli","Stew","Pumpkin","Hearty Stew","Corn","BBQ ribs","Apple","Mackerel","Salmon","Swordfish","Shark","Lionfish","Lava Eel","Cooked Lava Eel","Jellyfish","Strawberry","Meat? Sandwich","Honeycomb","Turkey Leg","Stuffing","Sweet Potato","Acorn"
    }
    ...
    local pelts = {"Bunny Foot","Wolf Pelt","Alpha Wolf Pelt","Bear Pelt","Scorpion Shell","Polar Bear Pelt","Arctic Fox Pelt","Blue Orchid","Pink Tulip","Yellow Peony","Red Rose","White Lily","Purple Carnation","Dino Kid's Lunchbox","Dino Kid's Yoyo","Dino Kid's Crayon", "Dino Kid's Dino Toy"}
